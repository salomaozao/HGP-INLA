...
##
blockNNGP <- function(case = "irregular", loc, loc_sf, y, X, w.obs, dir.save, n.partition, num.nb) {
  ### %%%%%%%%%%%%%%%%%%%%%%% START %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  blockNNGP.model <- inla.rgeneric.define(inla.rgeneric.blockNNGP.model,
    W = W, n = n,
